const About = () => {
	return (
		<div className='h-[51.25rem] px-[1.5rem] flex flex-col items-center'>
			{/* photo */}
			<div className='h-[18.75rem] w-full bg-cover bg-no-repeat bg-aboutBGMobile rounded-lg' />
			{/* title and text, to be placed to the left of the photo at desktop width */}
			<div className='flex flex-col items-center'>
				{/* title */}
				<h2 className='my-[2.5rem] font-bold text-[1.75rem] leading-[2.375rem] text-center tracking-[1px] uppercase text-black'>
					Bringing you the <span className='text-peru'>best</span> audio gear
				</h2>
				{/* text */}
				<p className='text-[15px] leading-[1.625rem] text-center text-black/50'>
