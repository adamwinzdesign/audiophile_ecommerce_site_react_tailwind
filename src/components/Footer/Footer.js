...
const Footer = () => {
	return (
		<div className='relative h-[40.875rem] md:h-[25rem] desk:h-[22.875rem] w-full pt-[3.25rem] md:pt-[3.75rem] pb-[2.375rem] md:pb-[2.875rem] px-[1.6rem] md:px-[2.375rem] desk:px-[10.375rem] flex flex-col items-center md:items-start md:justify-between gap-[3rem] md:gap-0 bg-black'>
			{/* brand accent */}
			...
			{/* info */}
			<div>
				<p className='text-[15px] leading-[25px] text-white/50 text-center md:text-left md:pb-[3.2rem]'>
